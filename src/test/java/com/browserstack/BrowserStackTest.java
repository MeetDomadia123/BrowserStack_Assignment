...
public class BrowserStackTest {
    ...
    public void testElPaisScraper(String browserName, String browserVersion,
        ...
        try {
            ...
            // Mark test as passed BEFORE quitting
            markTestStatus(driver, "passed", "Successfully scraped " + articles.size() + " articles");

            System.out.println("\nTEST PASSED: " + testLabel);

        } catch (Exception e) {
            markTestStatus(driver, "failed", e.getMessage());
    ...
    private void markTestStatus(WebDriver driver, String status, String reason) {
        try {
